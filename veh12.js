...
function checkQualification() {
    ...
    qualificationBadge.textContent = isQualified ? "Qualification Pending" : "You Don't Appear to Qualify";
    qualificationBadge.style.backgroundColor = isQualified ? "" : "#db0e02";
}
